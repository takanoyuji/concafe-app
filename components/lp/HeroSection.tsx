    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        {/* 予約は公式HPのフォームに一律で寄せる運用（2026-09-09決定）。
            LINEは友だち追加の導線として残し、予約の文言はこちらに持たせる */}
        <Link
          href="/reserve"
          className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl border border-star-400/50 bg-star-400/10 hover:bg-star-400/20 hover:border-star-400 transition-all duration-300 w-full max-w-xs sm:max-w-sm"
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-star-300" aria-hidden="true">
            <path d="M3 7h18v4a2 2 0 0 0 0 4v4H3v-4a2 2 0 0 0 0-4V7z" />
            <path d="M13 7v12" strokeDasharray="2 2" />
          </svg>
          <span className="text-star-300 font-bold text-sm">ご予約はこちら</span>
        </Link>
        ...
        >
          ...
          <span className="text-[#06C755] font-bold text-sm">公式LINE（友だち追加）</span>
        </a>
